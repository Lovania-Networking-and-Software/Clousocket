...
class BaseCacheImpl(typing.Generic[KT, VT]):
    ...
    Or use it for checking types::
        ...
        assert isinstance(apex.Cache(0), BaseCacheImpl)
        assert isinstance(apex.LRUCache(0), BaseCacheImpl)
        # ...
    """
...
class Cache(BaseCacheImpl[KT, VT]):
    ...
    def __init__(
        ...
        *,
        ...
        First example::
            ...
            cache = apex.Cache(100) # 100 is limit size
            cache.insert("key", "value")
            assert cache["key"] == "value"

        Second example::

            cache = apex.Cache(0) # zero means infinity
            cache.insert("key", "value")
            assert cache["key"] == "value"
        """
        ...
    ...
    def capacity(self) -> int:
        ...
        Second example::
            ...
            cache = apex.Cache(0, capacity=100)
    ...
    def shrink_to_fit(self) -> None:
        ...
        Example::
            ...
            cache = apex.Cache(0, {i:i for i in range(4)})
    ...
    def items(self) -> tuple_ptr_iterator[KT, VT]:
        ...
        Example::
            ...
            cache = apex.Cache(10, {i:i for i in range(10)})
...
class FIFOCache(BaseCacheImpl[KT, VT]):
    ...
    def capacity(self) -> int:
        ...
        Second example::
            ...
            cache = apex.FIFOCache(0, capacity=100)
            assert cache.capacity() == 100
            cache.insert(0, 0)
            assert cache.capacity() == 100
        """
    ...
    def setdefault(self, key: KT, default: DT = None) -> typing.Union[VT, DT]:
        ...
        Example::
            ...
            cache = apex.FIFOCache(0, {"exists", 1})
            assert cache["exists"] == 1
    ...
    def drain(self, n: int) -> int:
        ...
        Example::
            ...
            cache = apex.FIFOCache(0, {i:i for i in range(10)})
            assert len(cache) == 10
    ...
    def shrink_to_fit(self) -> None:
        ...
        Example::
            ...
            cache = apex.FIFOCache(0, {i:i for i in range(4)})
            assert cache.capacity() == 14 # maybe greater or lower, this is just example
            cache.shrinks_to_fit()
            assert cache.capacity() >= 4
        """
    ...
    def items(self) -> tuple_ptr_iterator[KT, VT]:
        ...
        Example::
            ...
            cache = apex.FIFOCache(10, {i:i for i in range(10)})
            for (key, value) in cache.items():
                print(key, value)
            # (3, 3)
            # (9, 9)
...
class LFUCache(BaseCacheImpl[KT, VT]):
    ...
    def capacity(self) -> int:
        ...
        Second example::
            ...
            cache = apex.LFUCache(0, capacity=100)
            assert cache.capacity() == 100
            cache.insert(0, 0)
            assert cache.capacity() == 100
        """
    ...
    def setdefault(self, key: KT, default: DT = None) -> typing.Union[VT, DT]:
        ...
        Example::
            ...
            cache = apex.LFUCache(0, {"exists", 1})
            assert cache["exists"] == 1
    ...
    def drain(self, n: int) -> int:
        ...
        Example::
            ...
            cache = apex.LFUCache(0, {i:i for i in range(10)})
            assert len(cache) == 10
            assert cache.drain(8) == 8
            assert len(cache) == 2
            assert cache.drain(10) == 2
    ...
    def shrink_to_fit(self) -> None:
        ...
        Example::
            ...
            cache = apex.LFUCache(0, {i:i for i in range(4)})
            assert cache.capacity() == 14 # maybe greater or lower, this is just example
            cache.shrinks_to_fit()
            assert cache.capacity() >= 4
        """
    ...
    def items(self) -> lfu_tuple_ptr_iterator[KT, VT]:
        ...
        Example::
            ...
            cache = apex.LFUCache(10, {i:i for i in range(10)})
            for (key, value) in cache.items():
                print(key, value)
            # (3, 3)
            # (9, 9)
...
class RRCache(BaseCacheImpl[KT, VT]):
    ...
    def capacity(self) -> int:
        ...
        Second example::
            ...
            cache = apex.RRCache(0, capacity=100)
            assert cache.capacity() == 100
            cache.insert(0, 0)
            assert cache.capacity() == 100
        """
    ...
    def drain(self, n: int) -> int:
        ...
        Example::
            ...
            cache = apex.RRCache(0, {i:i for i in range(10)})
            assert len(cache) == 10
            assert cache.drain(8) == 8
            assert len(cache) == 2
            assert cache.drain(10) == 2
    ...
    def shrink_to_fit(self) -> None:
        ...
        Example::
            ...
            cache = apex.RRCache(0, {i:i for i in range(4)})
            assert cache.capacity() == 14 # maybe greater or lower, this is just example
            cache.shrinks_to_fit()
            assert cache.capacity() >= 4
        """
    ...
    def items(self) -> tuple_ptr_iterator[KT, VT]:
        ...
        Example::
            ...
            cache = apex.RRCache(10, {i:i for i in range(10)})
            for (key, value) in cache.items():
                print(key, value)
            # (3, 3)
            # (9, 9)
...
class LRUCache(BaseCacheImpl[KT, VT]):
    ...
    def capacity(self) -> int:
        ...
        Second example::
            ...
            cache = apex.LRUCache(0, capacity=100)
            assert cache.capacity() == 100
            cache.insert(0, 0)
            assert cache.capacity() == 100
        """
    ...
    def setdefault(self, key: KT, default: DT = None) -> typing.Union[VT, DT]:
        ...
        Example::
            ...
            cache = apex.LRUCache(0, {"exists", 1})
            assert cache["exists"] == 1
    ...
    def drain(self, n: int) -> int:
        ...
        Example::
            ...
            cache = apex.LRUCache(0, {i:i for i in range(10)})
            assert len(cache) == 10
            assert cache.drain(8) == 8
            assert len(cache) == 2
            assert cache.drain(10) == 2
    ...
    def shrink_to_fit(self) -> None:
        ...
        Example::
            ...
            cache = apex.LRUCache(0, {i:i for i in range(4)})
            assert cache.capacity() == 14 # maybe greater or lower, this is just example
            cache.shrinks_to_fit()
            assert cache.capacity() >= 4
        """
    ...
    def items(self) -> tuple_ptr_iterator[KT, VT]:
        ...
        Example::
            ...
            cache = apex.LRUCache(10, {i:i for i in range(10)})
            for (key, value) in cache.items():
                print(key, value)
            # (3, 3)
            # (9, 9)
...
class TTLCache(BaseCacheImpl[KT, VT]):
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            cache = apex.TTLCache(5, ttl=3) # 3 seconds
            cache.insert(1, 1)
    ...
    def capacity(self) -> int:
        ...
        Second example::
            ...
            cache = apex.TTLCache(0, 10, capacity=100)
            assert cache.capacity() == 100
            cache.insert(0, 0)
            assert cache.capacity() == 100
        """
    ...
    def setdefault(self, key: KT, default: DT = None) -> typing.Union[VT, DT]:
        ...
        Example::
            ...
            cache = apex.TTLCache(0, 10, {"exists", 1})
            assert cache["exists"] == 1
    ...
    def drain(self, n: int) -> int:
        ...
        Example::
            ...
            cache = apex.TTLCache(0, 5, {i:i for i in range(10)})
            assert len(cache) == 10
            assert cache.drain(8) == 8
            assert len(cache) == 2
            assert cache.drain(10) == 2
    ...
    def shrink_to_fit(self) -> None:
        ...
        Example::
            ...
            cache = apex.TTLCache(0, 3, {i:i for i in range(4)})
            assert cache.capacity() == 14 # maybe greater or lower, this is just example
            cache.shrinks_to_fit()
            assert cache.capacity() >= 4
        """
    ...
    def items(self) -> ttl_tuple_ptr_iterator[KT, VT]:
        ...
        Example::
            ...
            cache = apex.TTLCache(10, 3, {i:i for i in range(10)})
            for (key, value) in cache.items():
                print(key, value)
            # (3, 3)
            # (9, 9)
...
class VTTLCache(BaseCacheImpl[KT, VT]):
    ...
    def __init__(
        ...
        *,
        ...
        Second Example::
            ...
            cache = apex.VTTLCache(10, {i:i for i in range(10)}, ttl=5)
            assert len(cache) == 10
            time.sleep(5)
            assert len(cache) == 0
        """
    ...
    def capacity(self) -> int:
        ...
        Second example::
            ...
            cache = apex.VTTLCache(0, capacity=100)
            assert cache.capacity() == 100
            cache.insert(0, 0, ttl=None)
            assert cache.capacity() == 100
        """
    ...
    def setdefault(
        ...
        Example::
            ...
            cache = apex.VTTLCache(0, {"exists", 1}, 10)
            assert cache["exists"] == 1
    ...
    def drain(self, n: int) -> int:
        ...
        Example::
            ...
            cache = apex.VTTLCache(0, {i:i for i in range(10)}, 5)
            assert len(cache) == 10
            assert cache.drain(8) == 8
            assert len(cache) == 2
            assert cache.drain(10) == 2
    ...
    def shrink_to_fit(self) -> None:
        ...
        Example::
            ...
            cache = apex.VTTLCache(0, {i:i for i in range(4)}, 5)
            assert cache.capacity() == 14 # maybe greater or lower, this is just example
            cache.shrinks_to_fit()
            assert cache.capacity() >= 4
        """
    ...
    def items(self) -> vttl_tuple_ptr_iterator[KT, VT]:
        ...
        Example::
            ...
            cache = apex.VTTLCache(10, {i:i for i in range(10)}, None)
            for (key, value) in cache.items():
                print(key, value)
            # (3, 3)
            # (9, 9)
    ...
    def values(self) -> vttl_object_ptr_iterator[VT]:
        ...
        Example::
            ...
            cache = apex.TTLCache(10, {i:i for i in range(10)}, None)
            for key in cache.values():
                print(key)
            # 5
            # 0
