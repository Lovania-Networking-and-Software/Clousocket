        ...
        for command_cn in range(3, 8):
            for risk in range(0, 11):
                ...
                if command_cn == 3 and risk >= 7:
                    self.y.append(1)
                    self.test_y.append(1)
                elif command_cn == 4 and risk >= 7:
                    self.y.append(1)
                    self.test_y.append(1)
                elif command_cn == 5 and risk >= 6:
                    self.y.append(1)
                    self.test_y.append(1)
                elif command_cn == 6 and risk >= 6:
                    self.y.append(1)
                    self.test_y.append(1)
                elif command_cn == 7 and risk >= 5:
                    self.y.append(1)
                    self.test_y.append(1)
                else:
                    self.x_without_outlier.append([risk, command_cn])
        ...
        for command_cn in range(8, 11):
            for risk in range(0, 11):
                ...
                if risk < 3:
                    ...
                    continue
                self.x.append([risk, command_cn])
                if command_cn == 8 and risk >= 6:
                    self.y.append(1)
                    self.test_y.append(1)
                elif command_cn == 9 and risk >= 6:
                    self.y.append(1)
                    self.test_y.append(1)
                elif command_cn == 10 and risk >= 5:
                    self.y.append(1)
                    self.test_y.append(1)
                else:
                    self.x_without_outlier.append([risk, command_cn])
